...
metadata {
	...
	tiles (scale: 2){
		...
		standardTile("reset", "device.reset", height: 2, width: 2, inactiveLabel: false, decoration: "flat") {
			state "reset", label:"Reset", action:"tileReset", icon:"st.lights.philips.hue-single", defaultState: true
		}
		...
		valueTile("transTime", "device.transitionTime", decoration: "flat", width: 2, height: 1) {
			state "transitionTime", label: 'Transition:              ${currentValue} s'
		}

		standardTile("effectControl", "device.effect", height: 2, width: 2, decoration: "flat") {
		...
		valueTile("colormode", "device.colormode", inactiveLabel: false, decoration: "flat", width: 2, height: 1) {
			state "val", label: 'Colormode: ${currentValue}', defaultState: true
		}
        ...
        valueTile("currentColor", "device.color", width: 2, height: 1) {
...
state "emptySmall", label:'', defaultState: true }
		...
		main(["rich-control"])
		details(["rich-control", "transitionTimeSliderControl", "transTime", "cdBrightnessControl", "cdColorControl", "colormode", "reachable", "currentColor", "effectControl", "rgbSelector", "refresh", "empty2x2", "reset", "empty2x2"])
	}
}
